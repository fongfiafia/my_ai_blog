export const dictionary = {
    ...
    privacy: {
        title: "隐私政策",
        lastUpdated: "最后更新时间：2024年10月26日",
        sections: [
            {
                title: "数据收集",
                content: "在我们的网站上，我们不收集访问者的任何个人信息。我们不使用Cookie或任何其他跟踪技术来收集您的信息。"
            },
            {
                title: "使用跟踪",
            ...
            {
                title: "您的权利",
                content: "由于我们不收集个人信息，因此没有关于访问、更正或删除个人数据的具体权利。但是，如果您对我们的隐私做法有任何问题或疑虑，请随时与我们联系。"
            },
            {
                title: "政策变更",
                content: "我们可能会不时更新此隐私政策。任何变更都将在本网站上发布，我们将更新政策顶部的最后更新日期。"
            }
        ],
        contact: {
            title: "联系我们",
            content: "如果您对本隐私政策有任何问题或疑虑，请通过以下邮箱联系我们："
        }
    },
    terms: {
        title: "服务条款",
        ...
        sections: [
            {
                title: "条款接受",
                content: "通过访问和使用本网站(https://lookai.top)，您接受并同意受本协议条款和规定的约束。"
            },
            {
                title: "使用许可",
                content: "允许临时下载LookAI网站上的材料（信息或软件）的一份副本，仅供个人、非商业性的临时查看。这是许可授予，而非所有权转让，根据此许可，您不得：修改或复制材料；将材料用于任何商业目的；试图反编译或反向工程网站上包含的任软件；删除材料中的任何版权或其他专有标记；或将材料转让给他人或在任何其他服务器上'镜像'材料。"
            },
            {
                title: "免责声明",
                content: "LookAI网站上的材料按'原样'提供。LookAI不作任何明示或暗示的保证，特此否认并否定所有其他保证，包括但不限于对适销性、特定用途适用性或不侵犯知识产权或其他权利的暗示保证或条件。"
            },
            {
                title: "责任限制",
                content: "在任何情况下，LookAI或其供应商均不对因使用或无法使用LookAI网站上的材料而造成的任何损害（包括但不限于数据或利润损失或由于业务中断而造成的损害）承担责任，即使LookAI或LookAI授权代表已口头或书面告知可能发生此类损害。"
            },
            {
                title: "材料准确性",
            ...
            {
                title: "链接",
                content: "LookAI尚未审查其网站链接的所有站，对任何此类链接网站的内容不承担责任。包含任何链接并不意味着LookAI对该网站的认可。使用任何此类链接网站的风险由用户自行承担。"
            }
        ],
        contact: {
            title: "联系我们",
            content: "如果您对这些服务条款有任何问题，请通过以下邮箱联系我们："
        }
    },
    userReviews: {
        title: "用户评价",
        reviews: [
            {
                content: "作为一个完全没有编程基础的设计师，Cursor让我也能轻松开发自己的创意项目。这个教程把复杂的概念解释得非常清楚！",
                author: "张小明",
                role: "UI设计师",
            ...
            {
                content: "从零基础到能够开发小程序，这个教程带我只用了两周时间。Cursor + GPT的组合确实很强大！",
                author: "王大力",
                role: "创业者",
                avatar: "/avatars/user3.jpg"
            },
            {
                content: "非常感谢这个教程！让我这个运营也能自己做一些简单的开发工作，大大提高了工作效率。",
                author: "陈雨",
                role: "产品运营",
